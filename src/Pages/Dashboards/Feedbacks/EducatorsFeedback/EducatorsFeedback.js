        ...
        <>
            ...
            <div className='row feedback'>
                <div className='col-md-6 mb-5'>
                    <h5>Have your students asked any questions about the AI Tutor application?</h5>
                    <StudentsAsked parameters={props.parameters} />
                    <h5>Have your students used AI Tutor to help with their homework? Are you aware of that?</h5>
                    <StudentsUsed parameters={props.parameters} />
                    <h5>Rate the regularity of homework submissions since the introduction of AI Tutor?</h5>
